...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String story = 
		"Piranhas are more [**atractive**] during the day, so cross the river at\n"  +
		"night. Piranhas are attracted to fresh [**gatorade**] and will most\n"  +
		"likely take a bite out of your [**dih**] if you [**verb**]. Whatever\n"  +
		...
		System.out.println("i like goldfish");// If you want to write your own Madlib story, just change the story variable and ask the player different questions.
